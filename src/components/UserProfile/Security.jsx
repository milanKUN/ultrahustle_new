    ...
    <div className="">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* New Password */}
          <div>
            <label className="text-xs font-bold text-[#2B2B2B]">New password</label>
            <div className="relative">
              <input
                type="password"
                placeholder="********"
      ...
      <div>
        ...
        <p className="mb-4">Currently login</p>
        ...
        <div className="flex bg-transparent  border-1 border-black items-center justify-between bg-white border rounded-md p-4 mb-3">
          <div>
            ...
            <p className="text-xs text-[#2B2B2B] flex items-center gap-1">
              ● Your Current Session
            </p>
          </div>
          <button className="bg-red-500 hover:bg-[#FF0000] text-white text-xs px-4 py-1.5 rounded-md">
            Log out
          </button>
        </div>
        ...
        <div className="flex bg-transparent border-1 border-black items-center justify-between bg-white border rounded-md p-4">
          <div>
            <p className="text-sm font-medium">1 session on iPhone16</p>
            <p className="text-xs text-gray-500">Chennai, Tamil Nadu, India</p>
