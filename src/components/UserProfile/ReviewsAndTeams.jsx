    ...
    <div className="space-y-20">
      ...
      <section>
        ...
        <div className="flex justify-end gap-3 mt-6">
          <button className="px-4 py-2 border border-black text-sm rounded-md text-gray-600">
            Discard
          </button>
          <button className="px-4 py-2 border border-black text-sm rounded-md bg-[#CEFF1B] font-medium">
            Save Changes
          </button>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r  rounded-2xl py-10">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* ACTION BUTTONS */}
          <div className="flex justify-end gap-3 mt-6">
            <button className="px-4 py-2 text-sm border-1 border-black rounded-md text-gray-700 bg-white">
              Discard
            </button>
            <button className="px-4 py-2 border-1 border-black text-sm rounded-md bg-[#CEFF1B] font-medium">
              Save Changes
            </button>
          </div>
        </div>
