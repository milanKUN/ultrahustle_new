  ...
  return (
    <>
      ...
      >
        ...
        {/* MAIN */}
        <div className="border-2 border-white bg-[#FEFEFE40] rounded-2xl p-6 mb-10">
        ...
        {/* PROJECTS GRID */}
        <div className="border-2 border-white bg-[#FEFEFE40] rounded-xl p-6 mb-6 flex flex-col">
