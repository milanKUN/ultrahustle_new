  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-[70%] bg-[#E0E0E0] md:bg-gradient-to-br md:from-[#E8E8E8] md:via-[#E0E0E0] md:to-[#D8D8D8] rounded-t-[50px] md:rounded-none -mt-16 md:mt-0 p-6 pt-8 md:p-12 flex flex-col justify-center items-center relative overflow-hidden min-h-[60vh] md:min-h-screen z-20">
        ...
        <div className="bg-transparent md:bg-white/30 backdrop-blur-xl rounded-[24px] md:rounded-[30px] shadow-xl p-8 md:p-16 w-[90%] md:w-[95%] h-auto md:h-[90%] max-w-none relative z-10 border border-[#CEFF1B] md:border-1 md:border-[#CEFF1B] flex flex-col justify-center items-stretch">
          {/* Top Content */}
