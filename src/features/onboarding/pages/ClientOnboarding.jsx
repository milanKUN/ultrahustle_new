...
export default function ClientOnboarding() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col min-[950px]:flex-row">
      ...
      <div className="w-full min-[950px]:w-[30%] relative overflow-hidden flex items-center justify-center h-[50vh] min-[950px]:h-auto">
      ...
      <div className="w-full min-[950px]:w-[70%] bg-[#E0E0E0] min-[950px]:bg-gradient-to-br min-[950px]:from-[#E8E8E8] min-[950px]:via-[#E0E0E0] min-[950px]:to-[#D8D8D8] rounded-t-[50px] min-[950px]:rounded-none -mt-16 min-[950px]:mt-0 p-6 pt-8 min-[950px]:p-12 flex flex-col justify-center items-center relative overflow-hidden min-h-[60vh] min-[950px]:min-h-screen z-20">
        ...
        <div className="bg-transparent min-[950px]:bg-white/30 backdrop-blur-xl rounded-[24px] min-[950px]:rounded-[30px] shadow-xl p-8 min-[950px]:p-16 w-[90%] min-[950px]:w-[95%] h-auto min-[950px]:h-[90%] max-w-none relative z-10 border border-[#CEFF1B] min-[950px]:border-1 min-[950px]:border-[#CEFF1B] flex flex-col justify-center items-stretch">
          {/* Top Content */}
          ...
          <div className="text-center max-w-[600px] mx-auto">
            ...
            <div className="flex flex-row gap-2 min-[950px]:gap-6 justify-center mb-6 min-[950px]:mb-14">
              <button
                ...
                className="px-5 min-[950px]:px-12 py-2.5 min-[950px]:py-4 rounded-lg min-[950px]:rounded-xl bg-[#CEFF1B] border border-black min-[950px]:border-2 text-black font-medium min-[950px]:font-semibold text-sm min-[950px]:text-2xl hover:bg-white hover:text-gray-900 transition-all duration-300 shadow-sm hover:shadow-[0_0_15px_#CEFF1B]"
              >
                Get Started
              </button>
