...
import { Headphones, GraduationCap, MonitorPlay, BookOpen } from "lucide-react";
    ...
    const listingTypes = [
        {
            ...
            subdesc: "Set your scope, pricing, timelines, and revisions clearly so both you and the client stay aligned from day one.",
        ...
        },
        {
            ...
            subdesc: "Upload once, set your license and price, and deliver instantly without manual work.",
            route: "#"
        },
        {
            id: "course",
            ...
            subdesc: "Organize lessons, control access, and give buyers a clean, distraction-free learning experience.",
            route: "#"
        },
        {
            id: "webinar",
            title: "Webinar",
            icon: <MonitorPlay size={80} strokeWidth={1.5} />,
            desc: "For live sessions or recorded events.",
            subdesc: "Schedule, collect registrations, and deliver your session without juggling multiple tools.",
            route: "#"
        }
    ];

    return (
        <div className={`add-listing-page user-page ${theme || "light"} min-h-screen relative overflow-hidden`}>
            {/* NAVBAR */}
            <UserNavbar
            ...
            <div className="pt-[85px] flex relative z-10 w-full">
                ...
                <div className="relative flex-1 min-w-5 overflow-hidden w-full">
                    {/* Scrollable Area */}
                    <div className="relative z-10 overflow-y-auto h-[calc(100vh-85px)] w-full">
                        <main className={`add-listing-main p-6 lg:p-10 ${isDropdownOpen ? "blurred" : ""}`}>

                            <div className="add-listing-header">
                                <h1 className="add-listing-title">What do you want to sell?</h1>
                                <p className="add-listing-subtitle">Pick the format that fits how you work. We will handle the structure so you can focus on creating and delivering.</p>
                            </div>
